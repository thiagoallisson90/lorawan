...
def build(bld):
    module = bld.create_ns3_module('lorawan', ['core', 'network',
                                               ...
                                               'buildings'])
    module.includes = ['/home/thiago/Documentos/Doutorado/Simuladores/ns-allinone-3.35/fuzzylite-6.0/fuzzylite']
    module.libpath = '/home/thiago/Documentos/Doutorado/Simuladores/ns-allinone-3.35/fuzzylite-6.0/fuzzylite/release'
    module.lib = 'fuzzylite'                                           
