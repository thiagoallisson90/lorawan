                                         ...
                                         int gwId)
{
  ...
  */
  if ( !std::isnan (packetCounts.at (0)) && !std::isnan(packetCounts.at (1)) )
    {
      output += std::to_string (packetCounts.at (0)) + "," +
                std::to_string (packetCounts.at (1)) + ",";
      double der = (double) packetCounts.at (1) / (double) packetCounts.at (0);
      output += std::to_string (der);
    }
