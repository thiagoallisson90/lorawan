...
std::vector<int> 
LorawanMacHelper::DRSFA1(NodeContainer endDevices,
                         NodeContainer gateways,
                         Ptr<LoraChannel> channel,
                         std::vector<double> toas,
                         std::vector<double> maxDelays,
...
std::vector<int> 
LorawanMacHelper::DRSFTPA(NodeContainer endDevices,
                          NodeContainer gateways,
                          Ptr<LoraChannel> channel,
                          std::vector<double> toas,
                          std::vector<double> maxDelays,
...
std::vector<int> 
LorawanMacHelper::SFTPA2_1(NodeContainer endDevices,
                         NodeContainer gateways,
                         Ptr<LoraChannel> channel,
                         std::vector<double> toas,
                         int nFreqs,
...
std::vector<int> 
LorawanMacHelper::SFTPA4(NodeContainer endDevices,
                         NodeContainer gateways,
                         Ptr<LoraChannel> channel,
                         std::vector<double> toas,
                         int nFreqs,
